...
class Agent():
    ...
    def __init__(self, mean_r = 1.1384, mean_g = 194.3558, std_r = 16.9998, std_g = 108.5659):    #path to location of parameters needs to be provided
        self.mean_g = mean_g
        self.mean_r = mean_r
        self.std_g = std_g
        self.std_r = std_r
        self.DenseNet = modelDefinition.DenseNet(in_channels=2, layer_size=[6,6,8,7], growth_rate=12, additional_neurons = 8)
        self.DenseNet.load_state_dict(torch.load(r"/home/niklas/Desktop/SW_Project/AIT_Racing/PyTorch_Implementation/ImageNet_Training/dropout_noise/trained_densenetepoch150.pth"
